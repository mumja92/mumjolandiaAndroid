...
import com.mumjolandia.android.ui.rootfs.RootFSRecyclerViewAdapter.ViewHolder
import com.mumjolandia.android.utils.TaskSupervisorHelper

class RootFSRecyclerViewAdapter internal constructor(context: Context?, data: List<String>) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.myTextView.text = mData[position].subSequence(1,mData[position].length)
        when (mData[position][0]){
            '&' -> {
